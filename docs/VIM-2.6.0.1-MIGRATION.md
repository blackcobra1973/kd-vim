# Vim 2.6.0.1 — yegappan/lsp Migration
...
Vim 2.6.0.1 starts from 2.5.0.4 and replaces the previous layered completion/LSP stack with a single Vim9-native LSP client:
